...
{
    public partial class M20220508145800 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentificationNumber = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: true),
                    ...
                    FundingType = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ARHis.People", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ARHis.People_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ARHis.People_Hospitals_HospitalId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Appointments_ARHis.People_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "ARHis.People",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Appointments_ARHis.People_PatientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoctorActivities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoctorActivities_ARHis.People_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "ARHis.People",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DoctorActivities_Hospitals_HospitalId",
                        column: x => x.HospitalId,
                        principalTable: "Hospitals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DoctorAvailabilities_ARHis.People_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "ARHis.People",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ARHis.People_HospitalId",
                table: "ARHis.People",
                column: "HospitalId");

            migrationBuilder.CreateIndex(
                name: "IX_ARHis.People_UserId",
                table: "ARHis.People",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorActivities_DoctorId",
                table: "DoctorActivities",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_DoctorActivities_HospitalId",
                table: "DoctorActivities",
                column: "HospitalId");
